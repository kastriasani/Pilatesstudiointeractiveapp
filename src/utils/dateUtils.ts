...
// ============ FRONTEND-SPECIFIC (with translations) ============

// These functions require the translations object and are frontend-only
// Import separately when needed:
//
// import { getLocalizedBookingDates, formatDateForDisplay } from './dateUtils.frontend';
